...
const DRAFT_PLAN_INTRO = 'ZhiYan Assistant is asking you to draft a GUI-owned implementation plan.'
const REFINE_PLAN_INTRO = 'ZhiYan Assistant is asking you to revise an existing GUI-owned implementation plan.'
