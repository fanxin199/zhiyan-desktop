...
import zhiyanLogo from '../../../../asset/img/zhiyan.svg'
...
export function AnimatedWorkLogo({
  ...
  return (
    ...
    >
      ...
      <img className="ds-work-logo-echo" src={zhiyanLogo} alt="" draggable={false} decoding="async" />
      <span className="ds-work-logo-track">
        <span className="ds-work-logo-body">
          <img className="ds-work-logo-image" src={zhiyanLogo} alt="" draggable={false} decoding="async" />
          <img className="ds-work-logo-tail" src={zhiyanLogo} alt="" draggable={false} decoding="async" />
        </span>
      </span>
    </span>
  )
