...
export const DEFAULT_WORKSPACE_ROOT = '~/.zhiyan/default_workspace'
...
export function mergeSettings(current: AppSettingsV1, patch: SettingsPatch): AppSettingsV1 {
  ...
  return {
    ...
    moduleContext: normalizeModuleContextSettings({
      projects: {
        ...safeCurrent.moduleContext.projects,
        ...(patch.moduleContext?.projects ?? {})
      },
      recent: {
        ...safeCurrent.moduleContext.recent,
        ...(patch.moduleContext?.recent ?? {})
      }
    }),
...
export function coerceRendererSettings(settings: AppSettingsV1): AppSettingsV1 {
  ...
  return {
    ...
    moduleContext: normalizeModuleContextSettings(raw.moduleContext),
