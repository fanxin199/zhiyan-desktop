...
const CLAW_SCHEDULE_MCP_MARKER_START = '# ZhiYan Assistant plugin:mcp:claw-schedule START'
const CLAW_SCHEDULE_MCP_MARKER_END = '# ZhiYan Assistant plugin:mcp:claw-schedule END'
